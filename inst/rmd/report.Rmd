...
if(!is.na(params$plotCap)) plot(params$plotCap)
```

### IR drop
```{r fig2, echo = FALSE, meessage = FALSE, fig.height=6, fig.width=8, fig.align="center"}

if(!is.na(params$plotIR)) plot(params$plotIR)
```
