...
### **Notes -2-: bat2dat specific *meta.csv* syntax**\
  *meta.csv* can be created from digital lab notebooks.\
  A POLiS and Kadi4Mat compatible notebook is provided in the examples folder (*labnotes_example.xlsx*).\
...
This is a basic example which shows you how to solve a common problem: blub
